...
sudo zypper in -y \
    glm-devel \
    libdmx-devel \
    libdrm-devel libdrm-devel-32bit \
    Mesa-demo-egl Mesa-demo-egl-32bit \
    Mesa-demo-es Mesa-demo-es-32bit \
    Mesa-demo-x Mesa-demo-x-32bit \
    Mesa-dri Mesa-dri-32bit Mesa-dri-devel \
    Mesa-libEGL-devel Mesa-libEGL-devel-32bit \
    Mesa-libGL-devel Mesa-libGL-devel-32bit \
    Mesa-vulkan-device-select Mesa-vulkan-device-select-32bit \
    Mesa-vulkan-overlay Mesa-vulkan-overlay-32bit \
    glslang-devel shaderc \
    piglit \
...
sudo zypper in -y \
    libvulkan_lvp \
    spirv-cross \
    spirv-tools spirv-tools-devel spirv-tools-devel-32bit \
    tree-sitter-glsl tree-sitter-hlsl \
    vulkan-tools vulkan-tools-32bit \
    vulkan-devel vulkan-devel-32bit \
